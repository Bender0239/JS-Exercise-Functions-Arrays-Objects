...
function temperatureInF(temp, u){
  if(u == "F"){
    return temp + "F";
  } else{
    return Math.round(temp * (9/5) + 32) + "C";
  }
}
//console.log(temperatureInF(32, "F"));
...
//console.log(makePersonObject(223, "Hayden", "hayden.bender@protonmail.com"))
/**
 * ### Challenge `getName`
 * 
 * @instructions
...
*/
let leia = { id: 1, name: 'Leia', email: 'leia@leia.com'};
function getName(){
...
*/
const appleArray = [ 'orange', 'grape', 'apple', 'banana', 'mango' ];
function appleIndex(newArray) {
  return newArray[2];
}
//console.log(appleIndex(appleArray));
/**
...
*/
let fruitArray = [ 'orange', 'apple', 'banana', 'apples', 'apple', 'mango' ];
const tOrF = [];
function isItAnApple(nextArray) {
  for(let i = 0; i <= fruitArray.length; i++){
    if(nextArray[i] === 'apple'){
      tOrF.push('true');
    } else {
      tOrF.push("false");
    }
...
//console.log(isItAnApple(fruitArray));
